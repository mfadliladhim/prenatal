...
$query2 = $connection->query("SELECT * FROM skrining WHERE identitas_id = '".$_GET['id']."'");
    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <button data-url="../controller/DeliveryController.php?a=delete_delivery&id=<?php echo $_GET['id'].'&id-d='.$_GET['id-d']; ?>" data-toggle="modal" data-target="#ConfirmDelete" class="btn btn-sm btn-prenatal-orange"><i class="fas fa-trash mr-1"></i> Hapus</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-3">
     ...
     <div class="col-md-9">
               ...
               <div class="card-body">
                 <!-- <div class="form-row">
                   <div class="form-group col-md-12">
                     ...
                     <!-- <input type="text" name="" class="form-control-plaintext border-bottom form-control-sm"> -->
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-3 d-flex align-items-center">
                     <input value="<?= $_GET['id']; ?>" type="text" name="identitas_id" class="form-control-plaintext border-bottom form-control-sm" hidden>
                     <input value="<?php echo $value1['tanggal_lahir_b']; ?>" type="date" name="tanggal_lahir_b" class="form-control-plaintext border-bottom form-control-sm">
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Tempat Lahir</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['tempat_lahir_b']; ?>" type="text" name="tempat_lahir_b" class="form-control-plaintext border-bottom form-control-sm">
                   </div>
                 </div>
                 <?php if ($value2['jumlah_janin'] > '1'): ?>
                   <div class="form-group row mt-2 mb-3">
                     ...
                     <div class="col-sm-8">
                       <button type="button" class="btn btn-prenatal-orange btn-sm" data-toggle="modal" data-target="#delivery_kembar1">
                 ...
                 <?php else: ?>
                   <div class="form-group row mb-0">
                     ...
                     <div class="col-md-4 d-flex align-items-center">
                       <div class="input-group input-group-sm input-group-merge">
                         <input value="<?php echo $value1['berat_lahir_b']; ?>" id="berat_lahir_b" name="berat_lahir_b" class="form-control" type="text">
                   ...
                   <div class="form-group row mb-0">
                     ...
                     <div class="col-sm-4 d-flex align-items-center">
                       <!-- <input type="text" name="panjang_lahir_b" class="form-control-plaintext border-bottom form-control-sm"> -->
                       <div class="input-group input-group-sm input-group-merge">
                         <input value="<?php echo $value1['panjang_lahir_b']; ?>" id="panjang_lahir_b" name="panjang_lahir_b" class="form-control" type="text">
                         <div class="input-group-append">
                   ...
                   <div class="form-group row mb-0">
                     ...
                     <div class="col-sm-4 d-flex align-items-center">
                       <!-- <input type="text" name="lingkar_kepala_bayi" class="form-control-plaintext border-bottom form-control-sm"> -->
                       <div class="input-group input-group-sm input-group-merge">
                         <input value="<?php echo $value1['lingkar_kepala_bayi']; ?>" id="lingkar_kepala_bayi" name="lingkar_kepala_bayi" class="form-control" type="text">
                         <div class="input-group-append">
                           <button class="btn btn-outline-prenatal-orange" type="button">cm</button>
                         </div>
                       </div>
                   ...
                   <div class="form-group row mb-0">
                     ...
                     <div class="col-sm-4 d-flex align-items-center">
                       <input value="<?php echo $value1['jenis_kelamin']; ?>" type="text" name="jenis_kelamin" class="form-control-plaintext border-bottom form-control-sm">
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['usia_kehamilan_saat_l']; ?>" type="text" name="usia_kehamilan_saat_l" class="form-control-plaintext border-bottom form-control-sm">
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Cara Persalinan</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['cara_persalinan']; ?>" type="text" name="cara_persalinan" class="form-control-plaintext border-bottom form-control-sm">
                     <!-- <select class="form-control-plaintext border-bottom form-control-sm" name="cara_persalinan">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['indikasi_induksi_persalinan']; ?>" type="text" name="indikasi_induksi_persalinan" class="form-control-plaintext border-bottom form-control-sm">
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Indikasi Vakum/Forsep/SC</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['indikasi_vakum_forsep_sc']; ?>" type="text" name="indikasi_vakum_forsep_sc" class="form-control-plaintext border-bottom form-control-sm">
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Butuh Transfusi Darah</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['butuh_transfusi_darah']; ?>" type="text" name="butuh_transfusi_darah" class="form-control-plaintext border-bottom form-control-sm">
                     <!-- <select name="butuh_transfusi_darah" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <!-- <input type="text" name="jumlah_pendarahan" class="form-control-plaintext border-bottom form-control-sm"> -->
                     <div class="input-group input-group-sm input-group-merge">
                       <input value="<?php echo $value1['jumlah_pendarahan']; ?>" id="jumlah_pendarahan" name="jumlah_pendarahan" class="form-control" type="text">
                       <div class="input-group-append">
             ...
             <div class="card">
               ...
               <?php if ($value2['jumlah_janin'] > '1'): ?>
                 <div class="form-group row mb-3">
                   <!-- <label class="col-sm-4 col-form-label form-control-label"></label> -->
                   <div class="col-sm-12">
                     <button type="button" class="btn btn-prenatal-orange btn-sm" data-toggle="modal" data-target="#delivery_kembar2">
                       <i class="fas fa-plus mr-1"></i>Data USG Janin Kembar
                     </button>
                   </div>
                 </div>
               <?php else: ?>
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-3 d-flex align-items-center">
                     <input value="<?php echo $value1['as_1']; ?>" type="text" name="as_1" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">AS 5</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['as_5']; ?>" type="text" name="as_5" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Butuh CPAP/Mixsafe</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['butuh_cpap_mixsafe']; ?>" type="text" name="butuh_cpap_mixsafe" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="butuh_cpap_mixsafe" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['asfiksia']; ?>" type="text" name="asfiksia" class="form-control-plaintext border-bottom form-control-sm">
                     <!-- <select name="asfiksia" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['rds']; ?>" type="text" name="rds" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="rds" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['sepsis']; ?>" type="text"  name="sepsis" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="sepsis" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['kelainan_bawaan']; ?>" type="text" name="kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-2 mt-2">
                   ...
                   <div class="col-sm-8 d-flex align-items-center">
                     <!-- <input type="text" name="jenis_kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea class="form-control-plaintext border-bottom form-control-sm" name="jenis_kelainan_bawaan" rows="3">value="<?php echo $value1['jenis_kelainan_bawaan']; ?>"</textarea>
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Kondisi Bayi Saat Lahir</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['kondisi_bayi_lahir']; ?>" type="text" name="kondisi_bayi_lahir" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select class="form-control-plaintext border-bottom form-control-sm" name="kondisi_bayi_lahir">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['tanggal_lahir_b']; ?>" type="text" name="lama_rawat_nicu" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">NICU admission</label>
                   <div class="col-sm-4 d-flex align-items-center">
                     <input value="<?php echo $value1['nicu_admission']; ?>" type="text" name="nicu_admission" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="nicu_admission" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
               ...
               <div class="card-body">
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-8 align-items-center">
                     ...
                     <!-- <input type="text" name="komplikasi_ibu_intrapartum" class="form-control-plaintext border-bottom form-control-sm" > -->
                   </div>
                 </div>
                 <hr class="mt-0 mb-3">
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-8 align-items-center">
                     ...
                     <!-- <input type="text" name="komplikasi_ibu_postpartum" class="form-control-plaintext border-bottom form-control-sm" > -->
                   </div>
                 </div>
                 <div class="form-group row mb-3">
                   <label class="col-sm-4 col-form-label form-control-label">Catatan Persalinan</label>
                   <div class="col-sm-8 align-items-center">
                     <!-- <input type="text" name="catatan_persalinan" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea class="form-control-plaintext border-bottom form-control-sm" name="catatan_persalinan" rows="3"><?php echo $value1['catatan_persalinan']; ?></textarea>
                   </div>
                 </div>
                 <div class="form-group row mb-3">
                   <label class="col-sm-4 col-form-label form-control-label">Data Klinis/Lab Pendukung</label>
                   <div class="col-sm-8 align-items-center">
                     <!-- <input type="text" name="data_klinis" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea class="form-control-plaintext border-bottom form-control-sm" name="data_klinis" rows="3"><?php echo $value1['data_klinis']; ?></textarea>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div class="card-body">
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 align-items-center">
                     <input value="<?php echo $value1['jenis_test_covid']; ?>" type="text" name="jenis_test_covid" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="jenis_test_covid" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['usia_kehamilan_saat_t']; ?>" type="text" name="usia_kehamilan_saat_t" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Tanggal Test</label>
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['tanggal_t']; ?>" type="date" name="tanggal_t" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Hasil Test</label>
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['hasil_t']; ?>" type="text" name="hasil_t" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="hasil_t" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['komorbid']; ?>" type="text" name="komorbid" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="komorbid" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-3">
                   ...
                   <div class="col-sm-8 align-items-center">
                     <!-- <input type="text" name="sebutkan_komorbid" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea class="form-control-plaintext border-bottom form-control-sm" name="sebutkan_komorbid" rows="3"><?php echo $value1['sebutkan_komorbid']; ?></textarea>
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-8 align-items-center">
                     ...
                     <!-- <input type="text" name="gejala_dirasakan" class="form-control-plaintext border-bottom form-control-sm" > -->
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Alat Bantu Napas</label>
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['alat_bantu_nafas']; ?>" type="text" name="alat_bantu_nafas" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="alat_bantu_nafas" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Tidak Ada">Tidak Ada</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-5 align-items-center">
                     <input value="<?php echo $value1['masuk_icu']; ?>" type="text" name="masuk_icu" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="masuk_icu" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Ya">Ya</option>
                       <option value="Tidak">Tidak</option>
                       <option value="Tidak tahu">Tidak tahu</option>
                 ...
                 <div class="form-group row mb-3">
                   ...
                   <div class="col-sm-8 align-items-center">
                     <!-- <input type="text" name="obat_didapat" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea class="form-control-plaintext border-bottom form-control-sm" name="obat_didapat" rows="3"><?php echo $value1['obat_didapat']; ?></textarea>
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Vaksinasi COVID</label>
                   <div class="col-sm-4 align-items-center">
                     <input value="<?php echo $value1['vaksinasi_c']; ?>" type="text" name="vaksinasi_c" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="vaksinasi_c" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 align-items-center">
                     <input value="<?php echo $value1['jumlah_dosis']; ?>" type="text" name="jumlah_dosis" class="form-control-plaintext border-bottom form-control-sm" >
                     <!-- <select name="jumlah_dosis" class="form-control-plaintext border-bottom form-control-sm">
                       <option value="">- Pilih -</option>
                       <option value="Tidak">Tidak</option>
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-4 align-items-center">
                     <input value="<?php echo $value1['tanggal_v']; ?>" type="date" name="tanggal_v" class="form-control-plaintext border-bottom form-control-sm" >
                   </div>
                 </div>
                 <div class="form-group row mb-0">
                   <label class="col-sm-4 col-form-label form-control-label">Catatan Vaksin / Test</label>
                   <div class="col-sm-8 align-items-center">
                     <!-- <input type="text" name="catatan_v" class="form-control-plaintext border-bottom form-control-sm" > -->
                     <textarea name="catatan_v" rows="3" class="form-control-plaintext border-bottom"><?php echo $value1['catatan_v']; ?></textarea>
                   </div>
                 </div>
       ...
       <!-- Modal kembar 1 -->
       <div class="modal fade" id="delivery_kembar1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
             ...
             <div class="modal-body">
               <div class="">
                 ...
                 <div class="form-group row mb-0">
                   ...
                   <div class="col-sm-5">
                     <!-- <input type="text" name="jenis_kelamin" class="form-control-plaintext border-bottom form-control-sm"> -->
                     <select class="form-control-plaintext border-bottom form-control-sm" name="jenis_kelamin">
                       <option value="">- Pilih -</option>
                       <option value="Laki-laki">Laki-laki</option>
                       <option value="Perempuan">Perempuan</option>
       ...
       <!-- Modal kembar 2 -->
       <div class="modal fade" id="delivery_kembar2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="modal-content">
             ...
             <form class="" action="index.html" method="post">
               <div class="modal-body">
                 <div class="">
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">AS 1</label>
                     <div class="col-sm-6">
                       <input type="text" name="as_1" class="form-control-plaintext border-bottom form-control-sm" >
                     </div>
                   </div>
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">AS 5</label>
                     <div class="col-sm-8">
                       <input type="text" name="as_5" class="form-control-plaintext border-bottom form-control-sm" >
                     </div>
                   </div>
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Butuh CPAP/Mixsafe</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="butuh_cpap_mixsafe" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select name="butuh_cpap_mixsafe" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ya">Ya</option>
                         <option value="Tidak">Tidak</option>
                   ...
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Asfiksia</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="asfiksia" class="form-control-plaintext border-bottom form-control-sm"> -->
                       <select name="asfiksia" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ya">Ya</option>
                         <option value="Tidak">Tidak</option>
                   ...
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">RDS</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="rds" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select name="rds" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ya">Ya</option>
                         <option value="Tidak">Tidak</option>
                   ...
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Sepsis</label>
                     <div class="col-sm-8">
                       <!-- <input type="text"  name="sepsis" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select name="sepsis" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ya">Ya</option>
                         <option value="Tidak">Tidak</option>
                   ...
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Kelainan Bawaan</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select name="kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ada">Ada</option>
                         <option value="Tidak Ada">Tidak Ada</option>
                   ...
                   <div class="form-group row mb-3">
                     ...
                     <div class="col-sm-8 d-flex align-items-center">
                       <!-- <input type="text" name="jenis_kelainan_bawaan" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <textarea class="form-control-plaintext border-bottom form-control-sm" name="jenis_kelainan_bawaan" rows="3"></textarea>
                     </div>
                   </div>
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Kondisi Bayi Saat Lahir</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="kondisi_bayi_lahir" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select class="form-control-plaintext border-bottom form-control-sm" name="kondisi_bayi_lahir">
                         <option value="">- Pilih -</option>
                         <option value="Lahir Hidup">Lahir Hidup</option>
                         <option value="Abortus (<20 minggu)">Abortus (&lt;20 minggu)</option>
                   ...
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">Lama Rawat NICU (hari)</label>
                     <div class="col-sm-8">
                       <input type="text" name="lama_rawat_nicu" class="form-control-plaintext border-bottom form-control-sm" >
                     </div>
                   </div>
                   <div class="form-group row mb-0">
                     <label class="col-sm-4 col-form-label form-control-label">NICU admission</label>
                     <div class="col-sm-8">
                       <!-- <input type="text" name="nicu_admission" class="form-control-plaintext border-bottom form-control-sm" > -->
                       <select name="nicu_admission" class="form-control-plaintext border-bottom form-control-sm">
                         <option value="">- Pilih -</option>
                         <option value="Ya">Ya</option>
                         <option value="Tidak">Tidak</option>
               ...
               <div class="modal-footer border-top">
                 ...
                 <button type="button" class="btn btn-prenatal-orange">Simpan</button>
               </div>
             </form>
           </div>
         </div>
